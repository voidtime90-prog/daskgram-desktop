...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DaskGram.DaskGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"DaskGram.DaskGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"DaskGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"DaskGram/DaskGram.lnk"_q;
	const auto old = u"DaskGram/DaskGram.lnk"_q;
